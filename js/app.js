document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderChurches(list) {
        ...
        paginatedItems.forEach(church => {
            ...
            if (church.communities.length > 0) {
                church.communities.forEach(community => {
                    ...
                    if (community.address) {
                        ...
                        communityAddress.textContent = `Endereço: ${community.address}`;
                    ...
                    if (community.schedule.length > 0) {
                        ...
                        noSchedule.className = 'schedule-item bg-gray-50 p-3 rounded-lg border-l-4 border-blue-500 dark:bg-gray-600 dark:border-blue-400 dark:text-gray-200';
                ...
                noCommunity.className = 'community text-gray-600 dark:text-gray-400';
